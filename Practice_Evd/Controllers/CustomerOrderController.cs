using Practice_Evd.Models;
using Practice_Evd.Models.ViewModel;
using System;
...
namespace Practice_Evd.Controllers
{
    public class CustomerOrderController : Controller
    {
        ...
        //{
        //    TempData["sdt"] = "";
        //    List<CustOrdVM> c = new List<CustOrdVM>();
        //    var a = db.Customers.ToList();
        //    foreach (var m2 in a)
        //    {
        //        c.Add(new CustOrdVM { CustomerID = m2.CustomerID, CutomerName = m2.CutomerName, BillingAddress = m2.BillingAddress, Imagepath = m2.Imagepath});
        //    }
        //    return View(c);
        ...
        public ActionResult List()
        {
            List<CustOrderVM> custOrdList = new List<CustOrderVM>();
